	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<ul>
			<li>
				...
				<img src="img/<?= $bk['gambar']; ?>" width="50"><br>
				<input type="file" name="gambar" id="gambar">
			</li><br>
			<li>
				<label for="kode_buku">Kode Buku	:</label><br>
				<input type="text" name="kode_buku" id="kode_buku" required value="<?= $bk["kode_buku"]; ?>">
			</li><br>
			<li>
			...
			<li>
				...
				<input type="text" name="penulis_buku" id="penulis_buku" required value="<?= $bk["penulis_buku"]; ?>">
			</li><br>

			<li>
				<label for="harga">Harga	:</label><br>
				<input type="price" name="harga" id="harga" required value="<?= $bk["harga"]; ?>">
			</li><br>
			<!-- <li>
